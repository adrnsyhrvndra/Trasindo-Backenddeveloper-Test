    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('update.pemesanan') }}" method="post">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    aria-describedby="name" placeholder=" " value="{{ $pemesanan->name }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="alamat" id="alamat" rows="2">{{ $pemesanan->alamat }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="no_id" class="form-control" name="no_id" id="no_id"
                                    aria-describedby="no_id" placeholder=" " value="{{ $pemesanan->no_id }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" id="email"
                                    aria-describedby="email" placeholder=" " value="{{ $pemesanan->email }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_telp" id="no_telp"
                                    aria-describedby="no_telp" placeholder=" " value="{{ $pemesanan->no_telp }}">
                            </div>
                        </div>
